...
train_pipeline = [
    dict(type='SampleFrames', clip_len=1, frame_interval=1, num_clips=24),
...
work_dir = '/home/fyp/FYP_Jingxi/mmaction2/self_defined_models/tsn/resnest/dataaug/24'
gpu_ids = [2]
omnisource = False
module_hooks = []
